...
(function ($)
{
    $.fn.LyFilter = function ()
    {
        return $.Lyui.run.call(this, "LyFilter", arguments);
    };

    $.fn.LyGetFilterManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetFilterManager", arguments);
    };
    ...
    $.LyDefaults.Filter.operators['string'] =
    $.LyDefaults.Filter.operators['text'] =
    ["equal", "notequal", "startwith", "endwith", "like", "greater", "greaterorequal", "less", "lessorequal", "in", "notin"];

    $.LyDefaults.Filter.operators['number'] =
    $.LyDefaults.Filter.operators['int'] =
    $.LyDefaults.Filter.operators['float'] =
    $.LyDefaults.Filter.operators['date'] =
    ["equal", "notequal", "greater", "greaterorequal", "less", "lessorequal", "in", "notin"];

    $.LyDefaults.Filter.editors['string'] =
    {
        create: function (container, field)
        {
            var input = $("<input type='text'/>");
            container.append(input);
            input.LyTextBox(field.editor.options || {});
            return input;
        },
    ...
    $.LyDefaults.Filter.editors['date'] =
    {
        create: function (container, field)
        {
            var input = $("<input type='text'/>");
            container.append(input);
            input.LyDateEditor(field.editor.options || {});
            return input;
        },
        setValue: function (input, value)
        {
            input.Ly('option', 'value', value);
        },
    ...
    $.LyDefaults.Filter.editors['number'] =
    {
        create: function (container, field)
        {
            var input = $("<input type='text'/>");
            ...
            input.LySpinner($.extend(options, field.editor.options || {}));
            return input;
        },
        setValue: function (input, value)
        {
    ...
    $.LyDefaults.Filter.editors['combobox'] =
    {
        create: function (container, field)
        {
            var input = $("<input type='text'/>");
    ...
    //过滤器组件
    $.Lyui.controls.Filter = function (element, options)
    {
        $.Lyui.controls.Filter.base.constructor.call(this, element, options);
    };

    $.Lyui.controls.Filter.LyExtend($.Lyui.core.UIComponent, {
        __getType: function ()
        {
            return 'Filter'
        },
        ...
        _init: function ()
        {
            ...
            $.Lyui.controls.Filter.base._init.call(this);
            //编辑构造器初始化
    ...
    $.LyFilter.getFilterFunction = function (condition)
    {
        if ($.isArray(condition))
            condition = { op: "and", rules: condition };
        var fnbody = ' return  ' + $.LyFilter.filterTranslator.translateGroup(condition);
