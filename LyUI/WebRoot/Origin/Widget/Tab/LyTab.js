...
(function ($)
{
    ...
    $.fn.LyTab = function (options)
    {
        return $.Lyui.run.call(this, "LyTab", arguments);
    };

    $.fn.LyGetTabManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetTabManager", arguments);
    };
    ...
    $.Lyui.controls.Tab = function (element, options)
    {
        $.Lyui.controls.Tab.base.constructor.call(this, element, options);
    };
    $.Lyui.controls.Tab.LyExtend($.Lyui.core.UIComponent, {
        __getType: function ()
        {
            return 'Tab';
        },
        ...
        _render: function ()
        {
            ...
            if (p.contextmenu && $.LyMenu)
            {
                g.tab.menu = $.LyMenu({ width: 100, items: [
        ...
        {
            if (!$.fn.LyDrag) return; //需要LyDrag的支持
            var g = this, p = this.options;
            if (value)
            {
                if (g.drags) return;
