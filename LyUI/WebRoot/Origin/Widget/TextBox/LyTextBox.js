...
(function ($)
{
    $.fn.LyTextBox = function ()
    {
        return $.Lyui.run.call(this, "LyTextBox", arguments);
    };

    $.fn.LyGetTextBoxManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetTextBoxManager", arguments);
    };
    ...
    $.Lyui.controls.TextBox = function (element, options)
    {
        $.Lyui.controls.TextBox.base.constructor.call(this, element, options);
    };

    $.Lyui.controls.TextBox.LyExtend($.Lyui.controls.Input, {
        __getType: function ()
        {
            return 'TextBox'
        },
        ...
        _init: function ()
        {
            $.Lyui.controls.TextBox.base._init.call(this);
