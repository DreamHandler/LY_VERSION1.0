...
(function ($)
{
    $.fn.LySpinner = function ()
    {
        return $.Lyui.run.call(this, "LySpinner", arguments);
    };
    $.fn.LyGetSpinnerManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetSpinnerManager", arguments);
    };
    ...
    $.Lyui.controls.Spinner = function (element, options)
    {
        $.Lyui.controls.Spinner.base.constructor.call(this, element, options);
    };
    $.Lyui.controls.Spinner.LyExtend($.Lyui.controls.Input, {
        __getType: function ()
        {
            return 'Spinner';
        },
        ...
        {
            return $.LyMethos.Spinner;
        },
        _init: function ()
        {
            $.Lyui.controls.Spinner.base._init.call(this);
            var p = this.options;
            if (p.type == 'float')
            {
                p.step = 0.1;
