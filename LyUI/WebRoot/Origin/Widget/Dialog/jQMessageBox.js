...
(function ($)
{
    ...
    $.YxMessageBox = function (options)
    {
        return $.Yxui.run.call(null, "YxMessageBox", arguments, { isStatic: true });
    };


    $.YxDefaults.MessageBox = {
        isDrag: true
    };

    $.YxMethos.MessageBox = {};

    $.Yxui.controls.MessageBox = function (options)
    {
        $.Yxui.controls.MessageBox.base.constructor.call(this, null, options);
    };
    $.Yxui.controls.MessageBox.YxExtend($.Yxui.core.UIComponent, {
        __getType: function ()
        {
            return 'MessageBox';
        },
        ...
        {
            var g = this, p = this.options;
            if (p.isDrag && $.fn.YxDrag)
                g.messageBox.YxDrag({ handler: '.l-messagebox-title-inner', animate: false });
        },
        _setImage: function ()
        {
            var g = this, p = this.options;
    ...
    $.YxMessageBox.show = function (p)
    {
        return $.YxMessageBox(p);
    };
    $.YxMessageBox.alert = function (title, content, type, onBtnClick)
    {
        title = title || "";
    ...
    $.YxMessageBox.confirm = function (title, content, callback)
    {
        var onclick = function (item, index, messageBox)
        {
            messageBox.close();
    ...
    $.YxMessageBox.success = function (title, content, onBtnClick)
    {
        return $.YxMessageBox.alert(title, content, 'success', onBtnClick);
    };
    $.YxMessageBox.error = function (title, content, onBtnClick)
    {
        return $.YxMessageBox.alert(title, content, 'error', onBtnClick);
    };
    $.YxMessageBox.warn = function (title, content, onBtnClick)
    {
        return $.YxMessageBox.alert(title, content, 'warn', onBtnClick);
    };
    $.YxMessageBox.question = function (title, content)
    {
        return $.YxMessageBox.alert(title, content, 'question');
    };
