...
(function ($)
{
    $.fn.LyDateEditor = function ()
    {
        return $.Lyui.run.call(this, "LyDateEditor", arguments);
    };

    $.fn.LyGetDateEditorManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetDateEditorManager", arguments);
    };

    $.LyDefaults.DateEditor = {
    ...
    $.Lyui.controls.DateEditor = function (element, options)
    {
        $.Lyui.controls.DateEditor.base.constructor.call(this, element, options);
    };
    $.Lyui.controls.DateEditor.LyExtend($.Lyui.controls.Input, {
        __getType: function ()
        {
            return 'DateEditor';
        },
