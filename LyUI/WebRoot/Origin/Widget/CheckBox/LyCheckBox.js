...
(function ($)
{
    $.fn.LyCheckBox = function (options)
    {
        return $.Lyui.run.call(this, "LyCheckBox", arguments);
    };
    $.fn.LyGetCheckBoxManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetCheckBoxManager", arguments);
    };
    $.LyDefaults.CheckBox = {
        disabled: false,
        readonly : false //只读
    ...
    $.Lyui.controls.CheckBox = function (element, options)
    {
        $.Lyui.controls.CheckBox.base.constructor.call(this, element, options);
    };
    $.Lyui.controls.CheckBox.LyExtend($.Lyui.controls.Input, {
        __getType: function ()
        {
            return 'CheckBox';
        },
