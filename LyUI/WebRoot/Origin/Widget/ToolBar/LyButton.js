...
(function ($)
{
    ...
    $.fn.LyButton = function (options)
    {
        return $.Lyui.run.call(this, "LyButton", arguments);
    };
    $.fn.LyGetButtonManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetButtonManager", arguments);
    };
    ...
    $.Lyui.controls.Button = function (element, options)
    {
        $.Lyui.controls.Button.base.constructor.call(this, element, options);
    };
    $.Lyui.controls.Button.LyExtend($.Lyui.controls.Input, {
        __getType: function ()
        {
            return 'Button';
        },
