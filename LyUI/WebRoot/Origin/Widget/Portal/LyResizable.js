...
(function ($)
{
    $.fn.LyResizable = function (options)
    {
        return $.Lyui.run.call(this, "LyResizable", arguments,
        {
            idAttrName: 'Lyuiresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };

    $.fn.LyGetResizableManager = function ()
    {
        return $.Lyui.run.call(this, "LyGetResizableManager", arguments,
        {
            idAttrName: 'Lyuiresizableid', hasElement: false, propertyToElemnt: 'target'
        });
    };
    ...
    $.Lyui.controls.Resizable = function (options)
    {
        $.Lyui.controls.Resizable.base.constructor.call(this, null, options);
    };

    $.Lyui.controls.Resizable.LyExtend($.Lyui.core.UIComponent, {
        __getType: function ()
        {
            return 'Resizable';
        },
        ...
        _render: function ()
        {
            ...
            g.target.mousemove(function (e)
            {
                ...
                if (p.target.Lyuidragid)
                {
                    var drag = $.Lyui.get(p.target.Lyuidragid);
                    if (drag && g.dir)
                    {
        ...
        _rendered: function ()
        {
            this.options.target.Lyuiresizableid = this.id;
        },
        _getDir: function (e)
        {
            var g = this, p = this.options;
