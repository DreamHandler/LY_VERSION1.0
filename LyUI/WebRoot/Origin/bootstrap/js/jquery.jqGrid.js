	...
	$.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
				...
				QueryObject = function(d, q) {
					...
					return d.length > 0 && (_useProperties = "object" == typeof d[0]), this._hasData = function() {
						...
						var g, h, i, j, k = [],
							l = [],
							m = "a" === c ? 1 : -1;
						void 0 === d && (d = "text"), j = "float" === d || "number" === d || "currency" === d || "numeric" === d ?
						function(a) {
			...
			if (!this.grid) {
				...
				var w, x = ["shiftKey", "altKey", "ctrlKey"],
					...
					L = function(a, b, c, e) {
						...
						if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
							...
							d.p.subGrid === !0 && (A = 1, p = $.jgrid.getMethod("addSubGridCell")), i.repeatitems || (I = F(j)), q = d.p.keyName === !1 ? $.isFunction(i.id) ? i.id.call(d, a) : i.id : d.p.keyName, r = -1 === String(q).indexOf("[") ? I.length ?
							function(a, b) {
								return $(q, a).text() || b
							} : function(a, b) {
				...
				$(d).before(e.hDiv).click(function(a) {
					...
					if ("A" !== fa.tagName && ("INPUT" !== fa.tagName && "TEXTAREA" !== fa.tagName && "OPTION" !== fa.tagName && "SELECT" !== fa.tagName || b)) if (ya = ga[0].id, fa = $(fa).closest("tr.jqgrow>td"), fa.length > 0 && (za = $.jgrid.getCellIndex(fa), Aa = $(fa).closest("td,th").html(), $(d).triggerHandler("jqGridCellSelect", [ya, za, Aa, a]), $.isFunction(d.p.onCellSelect) && d.p.onCellSelect.call(d, ya, za, Aa, a)), d.p.cellEdit !== !0) {
						if (c) if (d.p.multikey) a[d.p.multikey] ? $(d).jqGrid("setSelection", ya, !0, a) : d.p.multiselect && b && (b = $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya).is(":checked"), $("#jqg_" + $.jgrid.jqID(d.p.id) + "_" + ya)[d.p.useProp ? "prop" : "attr"]("checked", !b));
						else if (d.p.multiselect && d.p.multiboxonly) if (b) $(d).jqGrid("setSelection", ya, !0, a);
						else {
		...
		createModal: function(a, b, c, d, e, f, g) {
			...
			if (i && p.left && !f && (s = $(c.gbox).width() - (isNaN(c.width) ? 0 : parseInt(c.width, 10)) - 8, p.left = parseInt(p.left, 10) + parseInt(s, 10)), p.left && (p.left += "px"), $(l).css($.extend({
				...
				"aria-hidden": "true"
			}), void 0 === c.drag && (c.drag = !0), void 0 === c.resize && (c.resize = !0), c.drag) if ($(m).css("cursor", "move"), $.fn.tinyDraggable) $(l).tinyDraggable({
			...
			if (c.resize) if ($.fn.jqResize) $(l).append("<div class='jqResize " + j.resizable + " " + k.icon_base + " " + j.icon_resizable + "'></div>"), $("#" + $.jgrid.jqID(a.themodal)).jqResize(".jqResize", a.scrollelm ? "#" + $.jgrid.jqID(a.scrollelm) : !1);
			else try {
				$(l).resizable({
					handles: "se, sw",
